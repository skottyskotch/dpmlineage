...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 :OBJECT-NUMBER 128292478899
 :NAME "CS_BUTTON"
 :COMMENT "#@timeCard.save_sheet"
 :DATASET 96270999
 :EXTERNAL-ID 0
 :ORIGIN-NUMBER 0
 :ORIGIN-PROJECT 0
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace tcihmmod;ÿplw._IhmSaveCallback();"
 :_IHM_TB_AA_S_FILTER "FALSE AND tcihmmod_displayButtonSave()"
