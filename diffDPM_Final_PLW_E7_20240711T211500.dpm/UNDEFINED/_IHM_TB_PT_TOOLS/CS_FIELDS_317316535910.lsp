...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _rootproductcode;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "USER_ATTRIBUTE_SAN_RDPM_OC_ROOT_PRODUCT_CODE_FILTER"
 :_IHM_TB_AA_S_CHOICE_CLASS "__USER_TABLE_SAN_RWE_UT_PRODUCT"
