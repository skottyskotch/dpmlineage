...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _costaccountmain;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "USER_ATTRIBUTE_SAN_RDPM_UA_OC_S_COST_ACCOUNT_MAIN"
 :_IHM_TB_AA_S_CHOICE_CLASS "CBS-NODE"
 :_IHM_TB_AA_S_CLASS_NAME "CONTEXT-OPX2"
 :_IHM_TB_AA_S_FILTER "NOT IS_A_LEAF"
