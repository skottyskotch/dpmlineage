...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 :OBJECT-NUMBER 260070648872
 :NAME "_FF_AA_S_LIST_NAME"
 :COMMENT "Portfolio R&D"
 ...
 :_IHM_TB_AA_NP_SCRIPT "this.editor.apply();ÿrestoreValueFromOnbOnPortfolioFilter(context._FF_AA_S_LIST_NAME);ÿapplyFilter(context._FF_NF_S_FAVORITE_FORMULA);ÿif(context._KP_AA_S_PROJ_LIST != undefined)ÿ{ÿcontext._KP_AA_S_PROJ_LIST = \"\";ÿ}ÿ //RefreshProjectOrganisationMatrix(context.pm_matrix_widget);"
 ...
 (TEMP-TABLE::_IHM_TB_PT_TOOLS
  ...
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   ...
   :_IHM_TB_AA_B_ONLY_VISIBLE "0"
   :_IHM_TB_AA_B_SELECT_INPUT "0"
   :_IHM_TB_AA_NP_SCRIPT "var link = \"(:FVALUE :CONTEXT-OPX2 (620854699 . \\\"_FF_POPUP_FAVORITES\\\") NIL T NIL ÿ #.(:F\\\"\\\":STRING'#%ORDO-REQUEST:CONTEXT-OPX2:) T)\"; link = unescapeBackslash(link); link = link.stringReferenceToObject(); lispcall \"report-builder::ottp-go\" (context.applet,context,link,false);"
   :_IHM_TB_AA_S_FILTER "stratmod_portfolioFromContextLocked() = FALSE"
   :_IHM_TB_AA_S_FILTER2 "stratmod_portfolioFromContextLocked() = FALSE"
   :_IHM_TB_AA_S_NEED_TYPE "MANDATORY"
   :_IHM_TB_AA_S_TYPE "MENUS"
  )
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   :OBJECT-NUMBER 260070649272
   :NAME "new"
   :COMMENT "new"
   :DATASET 118081000141
   :EXTERNAL-ID 0
  ...
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   ...
   :_IHM_TB_AA_B_ONLY_VISIBLE "0"
   :_IHM_TB_AA_B_SELECT_INPUT "0"
   :_IHM_TB_AA_NP_SCRIPT "restoreValueFromOnbOnPortfolioFilter(context._FF_AA_S_LIST_NAME);ÿToolBar_EditPortfolio(\"_FF_POP_MODIFY_PORTFOLIO\");"
   :_IHM_TB_AA_S_FILTER "OPX2_CONTEXT._FF_AA_S_LIST_NAME <> \"\""
   :_IHM_TB_AA_S_FILTER2 "OPX2_CONTEXT._FF_AA_S_LIST_NAME <> \"\""
   :_IHM_TB_AA_S_NEED_TYPE "MANDATORY"
   :_IHM_TB_AA_S_TYPE "MENUS"
  )
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   :OBJECT-NUMBER 260070649672
   :NAME "open"
   :COMMENT "open"
   :DATASET 118081000141
   :EXTERNAL-ID 0
  ...
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   ...
   :_IHM_TB_AA_S_FILTER "stratmod_portfolioFromContextLocked() = FALSE  AND OPX2_CONTEXT._FF_AA_S_LIST_NAME <> \"\""
   :_IHM_TB_AA_S_FILTER2 "stratmod_portfolioFromContextLocked() = FALSE  AND OPX2_CONTEXT._FF_AA_S_LIST_NAME <> \"\""
   :_IHM_TB_AA_S_NEED_TYPE "MANDATORY"
   :_IHM_TB_AA_S_TYPE "MENUS"
  )
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   :OBJECT-NUMBER 260070650072
   ...
   :_IHM_TB_AA_S_FILTER "NOT _FF_AA_B_ONLY_FAVORITES AND stratmod_portfolioFromContextLocked() = FALSE"
   :_IHM_TB_AA_S_FILTER2 "_FF_AA_B_ONLY_FAVORITES AND stratmod_portfolioFromContextLocked() = FALSE"
   :_IHM_TB_AA_S_NEED_TYPE "MANDATORY"
   :_IHM_TB_AA_S_TYPE "MENUS"
  )
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   :OBJECT-NUMBER 260070650272
   ...
   :_IHM_TB_AA_B_ONLY_VISIBLE "0"
   :_IHM_TB_AA_B_SELECT_INPUT "0"
   :_IHM_TB_AA_NP_SCRIPT "var link = \"(:FVALUE :CONTEXT-OPX2 (611964999 . \\\"_INF_POPUP_SELECT_BUCKET\\\") NIL T ÿ NIL #.(:F\\\"\\\":STRING'#%ORDO-REQUEST:CONTEXT-OPX2:) T)\"; link = unescapeBackslash(link); link = link.stringReferenceToObject(); lispcall \"report-builder::ottp-go\" (context.applet,context,link,false);"
   :_IHM_TB_AA_S_FILTER "FALSE"
   :_IHM_TB_AA_S_NEED_TYPE "MANDATORY"
   :_IHM_TB_AA_S_TYPE "MENUS"
  )
  (TEMP-TABLE::_IHM_TB_PT_TOOLS
   :OBJECT-NUMBER 260070650472
   :NAME "reset"
   :COMMENT "reset"
   :DATASET 118081000141
   :EXTERNAL-ID 0
