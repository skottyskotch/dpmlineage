...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 :OBJECT-NUMBER 282811767741
 :NAME "CS_FIELDS"
 :COMMENT "OBSElement.plural"
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _san_pm_toolbar_obs;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "_PM_AA_S_OBS_PM_FILTER"
