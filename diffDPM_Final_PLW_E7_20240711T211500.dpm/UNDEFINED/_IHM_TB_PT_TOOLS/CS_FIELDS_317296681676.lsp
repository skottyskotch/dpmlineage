...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _san_ns_port_act;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "SAN_RDPM_UA_OC_MANAGING_UNIT_FILTER"
 :_IHM_TB_AA_S_CHOICE_CLASS "OBS-NODE"
 :_IHM_TB_AA_S_CLASS_NAME "CONTEXT-OPX2"
 :_IHM_TB_AA_S_FILTER "LIST_FIND(\"Continuum.RDPM.Pasteur\",PROJECT_TYPES) "
