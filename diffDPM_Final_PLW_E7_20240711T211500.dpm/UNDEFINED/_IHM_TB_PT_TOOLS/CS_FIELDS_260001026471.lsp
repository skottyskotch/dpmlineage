...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 :OBJECT-NUMBER 260001026471
 :NAME "CS_FIELDS"
 :COMMENT "WBSType.plural"
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _activitytype;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "_PM_AA_S_PM_WBSTYPE_FILTER"
 :_IHM_TB_AA_S_CHOICE_CLASS "WBS_TYPE"
