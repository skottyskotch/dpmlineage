...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 ...
 :_IHM_TB_AA_NP_DISP_SCRIPT "namespace tcpmmod;ÿdisplayScriptGroupBy();"
 :_IHM_TB_AA_NP_SCRIPT "namespace tcpmmod;ÿapplyGroupBy();"
 :_IHM_TB_AA_S_ATTR_NAME "_PM_TC_DA_S_GROUP_BY"
