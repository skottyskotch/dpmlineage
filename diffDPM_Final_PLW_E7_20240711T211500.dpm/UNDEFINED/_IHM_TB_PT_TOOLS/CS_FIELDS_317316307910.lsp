...
(TEMP-TABLE::_IHM_TB_PT_TOOLS
 ...
 :_IHM_TB_AA_NP_SCRIPT "namespace _studymanagername;ÿthis.editor.apply();"
 :_IHM_TB_AA_S_ATTR_NAME "USER_ATTRIBUTE_SAN_RDPM_OC_STUDY_MANAGER_NAME_FILTER"
 :_IHM_TB_AA_S_CHOICE_CLASS "OPX2-USER"
