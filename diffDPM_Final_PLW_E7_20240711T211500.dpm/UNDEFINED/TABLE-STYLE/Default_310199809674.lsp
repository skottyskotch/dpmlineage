...
(GRID::TABLE-STYLE
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_AUTO_LINKS
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :USER_ATTRIBUTE_SAN_RDPM_UA_S_MODIFICATION_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_LINK_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_PA_WBS_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_SA_WBS_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_DU_LAG_TIME
                :USER_ATTRIBUTE_SAN_RDPM_UA_B_SMOOTH_LINK :DATASET))
              (:SORT NIL) (:GROUP-BY #{ARBO:ARBO@^NTWK})
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_AUTO_LINKS)
              (:FOLLOW-SUBCLASSES T)
