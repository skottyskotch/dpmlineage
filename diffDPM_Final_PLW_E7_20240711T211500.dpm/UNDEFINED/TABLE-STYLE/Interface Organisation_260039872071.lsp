...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 260039872071
 :NAME "Interface Organisation"
 :ADVANCED-STYLE T
 :CONTEXT-DEPENDENCIES ((:CURVE-TYPE10 :ARCHIVE-PREDICTED-COST)
                        ...
                        (:UNIT2 #.(:ORF'#%TIME-TYPES:TIME-UNIT:"WEEK"))
                        (:UNIT1
                         #.(:cft'DOD:COST-UNIT "Default cost unit" 0))
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS KERNEL-ORDO:OBS-NODE
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:OBJECT-NUMBER :NAME :COMMENT :INACTIVE :OBS :NOTE-PAD
                :USER_ATTRIBUTE_SAN_RDPM_UA_B_OBS_BUDGET_OWNER
                :ORDER-NUMBER))
              (:SORT NIL)
              (:GROUP-BY
               (#{ARBO:ARBO@^OBS} #.(:gc ':_GPL1 ':_GPF1)
              ...
              (:THUMBNAIL-TOOLTIP-FORMULA #.(:F"NOTE_PAD":STRING'^OBS))
              (:THUMBNAIL-LABEL-FORMULA #.(:F"ID":STRING'^OBS))
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 969)
              ...
              (:LABEL-FORMULA #.(:F"FAUX":BOOLEAN'^OBS))
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:DATASET 10 :OBS-NODE_COLOR 5 :_INF_DA_OBS_FINAL_COLOR
                15 :OBS_ELEMENT_COLOR 1 :_INF_SF_OBS_COLOR 6 :NOTE-PAD
                20 :USER-MANAGER 10 :NAME 15 :COMMENT 20 :OBS 4))
