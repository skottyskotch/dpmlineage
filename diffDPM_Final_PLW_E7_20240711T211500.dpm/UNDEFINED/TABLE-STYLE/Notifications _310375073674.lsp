...
(GRID::TABLE-STYLE
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_SOURCING_REQUEST_NOTIFICATION
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIF_SOURCING_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_ROLE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_STATUS
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_CANCELLATION_STATUS
                :USER_ATTRIBUTE_SAN_UA_RDPM_S_CANCELLED_BY
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIFICATION
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIFICATION_TYPE
                :DATASET))
              (:SORT NIL)
              (:GROUP-BY
               ((:USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIF_SOURCING_TYPE
                 :_GPL1)))
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_SOURCING_REQUEST_NOTIFICATION)
              (:FOLLOW-SUBCLASSES T)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:USER_ATTRIBUTE_SAN_RDPM_UA_S_ROLE 14
                :USER_ATTRIBUTE_SAN_UA_RDPM_S_CANCELLED_BY 12
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_CANCELLATION_STATUS 12
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_STATUS 12
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIF_SOURCING_TYPE 14))
              (:SUMAV-TO-DO NIL) (:SPLIT-INFO NIL)
              (:FIXED-WIDTH-ATTRIBUTES
               (:USER_ATTRIBUTE_SAN_RDPM_UA_S_ROLE T
                :USER_ATTRIBUTE_SAN_UA_RDPM_S_CANCELLED_BY T
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_CANCELLATION_STATUS T
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_STATUS T
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_NOTIF_SOURCING_TYPE T))
              (:CHANGED-FORMATS NIL))
 :OWNER 5625
 :TABLE-WIDTH 0
