...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 310375072974
 :NAME "Next status list"
 :ADVANCED-STYLE T
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_SOURCING_REQUEST_NEXT_STATUS
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_STATUS_SOURCING_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_SOURCING_TOOL_ROLE
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_SOURCING_TOOL_CUR_STATUS
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_SOURCING_TOOL_NEXT_STATUS
                :DATASET))
              (:SORT NIL)
              (:GROUP-BY
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_SOURCING_REQUEST_NEXT_STATUS)
              (:FOLLOW-SUBCLASSES T)
              ...
              (:ATTRIBUTE-WIDTH-PLIST NIL) (:SUMAV-TO-DO NIL)
              (:SPLIT-INFO NIL) (:FIXED-WIDTH-ATTRIBUTES NIL)
              (:CHANGED-FORMATS NIL))
 :OWNER 5625
 :TABLE-WIDTH 0
