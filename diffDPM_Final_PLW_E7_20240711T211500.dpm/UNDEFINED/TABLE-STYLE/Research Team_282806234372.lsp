...
(GRID::TABLE-STYLE
 ...
 :CONTEXT-DEPENDENCIES ((:CURVE-TYPE10 :ARCHIVE-PREDICTED-COST)
                        ...
                        (:_RE_AA_B_MENU_CLOSED T)
                        (:*APPLY-63-LOOK-AND-FEEL-AT-STARTUP* T)
                        (:_GS_AA_S_USER_SETTINGS_FILE "GLOBALSETTINGS"))
 :DATASET 118081000141
 :FILTER "( LIST_FIND(\"R\",SAN_RDPM_UA_PROJECT_ROLE.SAN_RDPM_UA_ROLE_PROJECT_CATEGORY) )"
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_PROJECT_TEAM_MEMBER
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:USER_ATTRIBUTE_SAN_RDPM_UA_SCOPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_PROJECT_ROLE
                :USER_ATTRIBUTE_SAN_RDPM_UA_PROJECT_ROLE_DESC
                :USER_ATTRIBUTE_SAN_RDPM_UA_USER
                :USER_ATTRIBUTE_SAN_RDPM_UA_USER_DESC
                :USER_ATTRIBUTE_SAN_RDPM_UA_USER_EMAIL
                :USER_ATTRIBUTE_SAN_RDPM_UA_B_PROJECT_TEAM_USER_IS_ACTIVE
                :USER_ATTRIBUTE_SAN_RDPM_UA_PROJECT_TEAM_MEMBER_TEAMS
                :USER_ATTRIBUTE_SAN_RDPM_UA_PROJECT_TEAM_MEMBER_SUBTEAMS
                :DATASET))
              (:SORT NIL)
              (:GROUP-BY
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 841)
              (:SHELL-WIDTH 1696) (:READ-WRITE-COLOR :WHITE)
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_PROJECT_TEAM_MEMBER)
              (:FOLLOW-SUBCLASSES T)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:USER_ATTRIBUTE_SAN_RDPM_UA_PROJECT_ROLE_DESC 20
                :USER_ATTRIBUTE_SAN_RDPM_UA_USER 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_USER_EMAIL 20
                :USER_ATTRIBUTE_SAN_RDPM_UA_CORE_TEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_EXTENDED_TEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_CMC_SUBTEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_CHINA_SUBTEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_EXTENDED_CLINICAL_SUBTEAM
                10 :USER_ATTRIBUTE_SAN_RDPM_UA_JAPAN_SUBTEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_TRANSLATIONAL_SUBTEAM 10
                :USER_ATTRIBUTE_SAN_RDPM_UA_SCOPE 20))
