...
(GRID::TABLE-STYLE
 ...
 :GROUP-READ-ONLY (#.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_RBS" NIL))
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_RES_CTR_TYP
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :COMMENT :SAN_RDPM_UT_RES_CTR_TYP
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_END_DATE_REQ :NOTE-PAD
                :DATASET))
              (:SORT NIL)
              (:GROUP-BY
               (#.(:UNFINALIZED 'ARBO:ARBO '"OPX2-USER:__USER_TABLE_SAN_RDPM_UT_RES_CTR_TYP" NIL)
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_RES_CTR_TYP)
              (:FOLLOW-SUBCLASSES T) (:LABEL-FONT :DEFAULT-FONT)
