...
(GRID::TABLE-STYLE
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS CALENDAR:CALENDAR
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :INHERIT-REST-FROM
                :USER_ATTRIBUTE_SAN_RDPM_S_CAL_TC_MSG :HOLIDAYS
                :EXCEPTIONS :DATASET))
              (:SORT (:NAME))
              (:GROUP-BY
               (#{ARBO:ARBO@^CALD} #.(:gc ':_GPL1 ':_GPF1)
              ...
              (:THUMBNAIL-TOOLTIP-FORMULA #.(:F"":STRING'^CALD))
              (:THUMBNAIL-LABEL-FORMULA #.(:F"ID":STRING'^CALD))
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 498)
              (:SHELL-WIDTH 1077) (:READ-WRITE-COLOR :WHITE)
              (:READ-ONLY-COLOR :ROCC) (:LABEL-SUPRESSED-COLOR :GREY)
              (:LABEL-MODIFIED-COLOR :DARK-GREEN)
              (:LABEL-DEFAULT-COLOR :BLACK) (:LABEL-COLOR :RED)
              (:LABEL-FORMULA #.(:F"FALSE":BOOLEAN'^CALD))
              ...
              (:OBJECT-CLASS CALENDAR:CALENDAR) (:FOLLOW-SUBCLASSES T)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:EXCEPTIONS 20 :HOLIDAYS 20 :INHERIT-REST-FROM 10 :NAME
                26))
              (:SUMAV-TO-DO NIL) (:SPLIT-INFO NIL)
              (:FIXED-WIDTH-ATTRIBUTES (:NAME T))
              (:CHANGED-FORMATS NIL))
 :OWNER 5625
 :TABLE-WIDTH 0
