...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 260009661474
 :NAME "WBS Form - Leader mapping"
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UR_WBS_FORM_MAP_LEADER
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :USER_ATTRIBUTE_SAN_UA_RDPM_S_ROLE
                :USER_ATTRIBUTE_SAN_UA_RDPM_S_ACT_TYPE
                :USER_ATTRIBUTE_SAN_UA_RDPM_S_OBS :DATASET))
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 920)
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UR_WBS_FORM_MAP_LEADER)
              (:FOLLOW-SUBCLASSES T)
