...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 142734896141
 :NAME "Liste Resources"
 :CONTEXT-DEPENDENCIES ((:CURVE-TYPE10 :ARCHIVE-PREDICTED-COST)
                        ...
                        (:GEN_HEADER_FILT_RES "Sanofi")
                        (:USER_ATTRIBUTE_SAN_UA_CP_RES_CTR_TYP "")
                        (:_GS_AA_S_USER_SETTINGS_FILE "GLOBALSETTINGS"))
 :DATASET 118081000141
 :FILTER "( if oc.SAN_UA_CP_RES_CTR_TYP<>\"\" then SAN_UA_RDPM_RES_CTR_TYP=oc.SAN_UA_CP_RES_CTR_TYP else true fi ) AND (IF NOT(OC.SAN_UA_RES_DISPLAY_INACTIVE) THEN NOT(INACTIVE) FI)"
 :GROUP-READ-ONLY (#.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_PM_CHC" NIL))
 ...
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :COMMENT :DATASET
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_CTR_TYP :USER-MANAGER
                :CONTROLLER :|Res_manager| :_TC_DA_S_TC_PROFILE
                :_TC_DA_S_TC_PORTFOLIO :RSKILLS :COST-VALUE :TIME-UNIT
                :RESOURCE_COLOR))
              (:SORT NIL)
              (:GROUP-BY
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 587)
              (:SHELL-WIDTH 1280) (:READ-WRITE-COLOR :|16777215|)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:_INF_SF_RES_COLOR 4 :RESOURCE_FILE 6 :RSKILLS 29
                :COMMENT 10 :NAME 10 :OBS 11 :ELEMENT-OF 14))
