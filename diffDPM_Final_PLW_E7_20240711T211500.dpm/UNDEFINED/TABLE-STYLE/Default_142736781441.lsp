...
(GRID::TABLE-STYLE
 ...
 :CONTEXT-DEPENDENCIES ((:CURVE-TYPE10 :ARCHIVE-PREDICTED-COST)
                        ...
                        (:_RE_AA_S_CURRENT_MODULE "ADM_HOME")
                        (:_CAR_AA_S_SINGLE_APP_WF_FILTER "")
                        (:USER_ATTRIBUTE_SAN_UA_RES_DISPLAY_INACTIVE
                         NIL)
                        (:USER_ATTRIBUTE_SAN_UA_CP_RES_CTR_TYP ""))
 :DATASET 118081000141
 :FILTER "( ( ( ( ( ( ( ( (IF OC.SAN_UA_CP_RES_CTR_TYP<>\"\" THEN SAN_UA_RDPM_RES_CTR_TYP=OC.SAN_UA_CP_RES_CTR_TYP ELSE TRUE FI) AND (IF NOT(OC.SAN_UA_RES_DISPLAY_INACTIVE) THEN NOT(INACTIVE) ELSE TRUE FI) ) ) ) ) ) ) ) )"
 :GROUP-READ-ONLY (#.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_MSP" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_PM_CHC" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_RWE" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_ADM" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_CARE" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_CONTRIBUTOR" NIL)
                   #.(:UNFINALIZED 'GENERIC-IO:GROUP-OR-USER '"P_RBS" NIL))
 ...
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:INACTIVE :USER_ATTRIBUTE_SAN_RDPM_B_RES_SIMU
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_OPEN :NAME :COMMENT
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_OP_SERV
                :USER_ATTRIBUTE_SAN_RDPM_UA_RES_SHARED
                :USER_ATTRIBUTE_SAN_RDPM_S_RES_HIR_MANAG
                :USER_ATTRIBUTE_SAN_RDPM_UT_RES_REC_STAT
                :USER_ATTRIBUTE_SAN_RDPM_RES_THER_AREA
                :SAN_RDPM_SF_USR_ACTIV_AD
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_PERC_ALLOC
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_PERC_AVAIL
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_PERC_CONTR
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_PERC_DIRECT
                :USER_ATTRIBUTE_SAN_RDPM_RES_S_WORK_DAY_REF
                :USER_ATTRIBUTE_SAN_RDPM_RES_QUANT
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_OPER
                :USER_ATTRIBUTE_SAN_RDPM_RES_ROLE_TYPE
                :USER_ATTRIBUTE_SAN_RDPM_UA_RES_REC_TYP
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_CTR_TYP :PRIMARY-SKILL
                :RSKILLS :USER_ATTRIBUTE_SAN_UA_RDPM_RES_POS_NUM
                :USER_ATTRIBUTE_SAN_UA_RDPM_RES_EMPL_NUM
                :USER_ATTRIBUTE_SAN_RDPM_RES_B_EXCL_HEAD
                :SAN_RDPM_SF_RES_INACT_QC
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_TYP_MOV_OUT
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_TYP_MOV_IN
                :USER_ATTRIBUTE_SAN_RDPM_UA_RES_MOVE_REASON
                :USER_ATTRIBUTE_SAN_RDPM_RES_BAS_ENTITY))
              (:SORT NIL)
              (:GROUP-BY
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 649)
              (:SHELL-WIDTH 1390) (:READ-WRITE-COLOR :|16777215|)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:DATASET 21 :_INF_SF_RES_COLOR 4 :RESOURCE_FILE 6
                :RSKILLS 29 :COMMENT 10 :NAME 32 :OBS 11 :ELEMENT-OF
                14))
              (:SUMAV-TO-DO NIL) (:SPLIT-INFO NIL)
              (:FIXED-WIDTH-ATTRIBUTES (:NAME T :DATASET T))
              (:CHANGED-FORMATS NIL))
 :OWNER 5625
 :TABLE-WIDTH 0
