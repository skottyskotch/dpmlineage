...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 317323141574
 :NAME "Pack Load - Error Style"
 :ADVANCED-STYLE T
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_PACK_LOAD_IMPORT
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :USER_ATTRIBUTE_SAN_RDPM_UA_N_PACK_LOAD
                :USER_ATTRIBUTE_SAN_RDPM_UA_S_PACK_LOAD_IMPORT_ERROR))
              (:SORT NIL)
              (:GROUP-BY
              ...
              (:FORMULA
               #.(:F"[(MATCH_STRING(OPX2_CONTEXT._INF_AA_S_FILTER))] AND SAN_RDPM_UA_S_PACK_LOAD_IMPORT_ERROR<>\"\" ":BOOLEAN'#%OBJECT:EMPTY-CLASS:))
              (:SHOW-OBJECT-ICONS 0) (:SHOW-HIDDEN-OBJECTS 0)
              (:SPACE-BETWEEN-GROUP 12)
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_PACK_LOAD_IMPORT)
              (:FOLLOW-SUBCLASSES T)
