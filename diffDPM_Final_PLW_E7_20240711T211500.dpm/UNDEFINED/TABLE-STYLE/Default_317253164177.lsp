...
(GRID::TABLE-STYLE
 ...
 :CONTEXT-DEPENDENCIES ((:CURVE-TYPE10 :ARCHIVE-PREDICTED-COST)
                        ...
                        (:CURVE-TYPE4 #.(:CC :SAN_RDPM_CC_HEAD))
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_STUDY_CURRENCY_EXP
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :USER_ATTRIBUTE_SAN_RDPM_UA_ACTIVITY
                :USER_ATTRIBUTE_SAN_RDPM_UA_COST_ACCOUNT
                :USER_ATTRIBUTE_SAN_RDPM_UA_CURRENRY :DATASET
                :USER_ATTRIBUTE_SAN_RDPM_UA_QC_MSG))
              (:SORT NIL) (:GROUP-BY NIL)
              ...
              (:ADJUST-LINE-HEIGHT-TO-CONTENT 0) (:SHELL-HEIGHT 860)
              (:SHELL-WIDTH 1726) (:READ-WRITE-COLOR :WHITE)
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_STUDY_CURRENCY_EXP)
              (:FOLLOW-SUBCLASSES T)
              ...
              (:ATTRIBUTE-WIDTH-PLIST
               (:DATASET 20 :USER_ATTRIBUTE_SAN_RDPM_UA_CURRENRY 11
                :USER_ATTRIBUTE_SAN_RDPM_UA_COST_ACCOUNT 33 :NAME 29))
              (:SUMAV-TO-DO NIL) (:SPLIT-INFO NIL)
              (:FIXED-WIDTH-ATTRIBUTES
               (:USER_ATTRIBUTE_SAN_RDPM_UA_CURRENRY T
                :USER_ATTRIBUTE_SAN_RDPM_UA_COST_ACCOUNT T :NAME T))
              (:CHANGED-FORMATS NIL))
 :OWNER 5625
