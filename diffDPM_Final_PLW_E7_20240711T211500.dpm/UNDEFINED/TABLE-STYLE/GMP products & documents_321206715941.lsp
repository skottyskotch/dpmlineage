...
(GRID::TABLE-STYLE
 :OBJECT-NUMBER 321206715941
 :NAME "GMP products & documents"
 ...
 :IGNORED-DEPENDENCIES (:UNIT1 :UNIT2 :UNIT3 :UNIT4 :UNIT5 :TIME-UNIT1
                        ...
                        :TIME-UNIT-FORM5)
 :ON-CLASS OPX2-USER::__USER_TABLE_SAN_RDPM_UT_ACT_PROT_BRD
 :OTHER-DATA (:OBJECT-GRID (:COLUMN-GROUPS NIL)
              (:ATTRIBUTES
               (:NAME :SAN_RDPM_UT_ACT_PROT_BRD
                :USER_ATTRIBUTE_SAN_RDPM_UA_PROD_TYPE :COMMENT
                :NOTE-PAD :DATASET))
              ...
              (:OBJECT-CLASS
               OPX2-USER::__USER_TABLE_SAN_RDPM_UT_ACT_PROT_BRD)
              (:FOLLOW-SUBCLASSES T)
