...
function san_rdpm_js2_create_monthly_baseline()
{
	...
	{
		ref_obj = new plc._L1_PT_REF_ADMIN (NAME : ref_name,DESC : ref_name,_L1_AA_S_REF_TEMPLATE : \"SAN_RDPM_MONTHLY_BASELINE\",_L1_AA_B_REF_IS_LOADED : true,_L1_AA_S_REF_PRJTYP : \"Continuum.RDPM.Pasteur\",FILE : \"SAN_CF_RDPM_COMMON_DATA_VACCINES\");	
...
function san_rdpm_js2_create_yearly_baseline_name()
{
	...
	{
		ref_obj = new plc._L1_PT_REF_ADMIN (NAME : ref_name,DESC : ref_name,_L1_AA_S_REF_TEMPLATE : \"SAN_RDPM_YEARLY_BASELINE\",_L1_AA_B_REF_IS_LOADED : true,_L1_AA_S_REF_PRJTYP : \"Continuum.RDPM.Pasteur\",FILE : \"SAN_CF_RDPM_COMMON_DATA_VACCINES\");	
		plw.writeln(\"Creation a new Reference : \"+ref_obj);
...
function san_rdpm_take_automatic_study_baseline(refName,refDesc,relation_name)
{
	...
	// PC-4692 - Limit study baseline to Pharma Projects
	for (var vact in baseline.get(relation_name) where vact.PROJECT.SAN_RDPM_B_RND_PHARMA_PROJECT)
	{
...
"
 ...
 :VERSION 21
 :_US_AA_D_CREATION_DATE 20211214000000
 :_US_AA_S_OWNER "E0491209"
)