...
* JIRA : PC-5961 - Deleltion of 'Vaccine Project Category' and \"Vaccine Project Sub-category\" manual values are set back to the calculated value after the Monthly Baseline has runned. 
* Date Modification : 08/04/2022 by Abdelaali
*/
...
"
 ...
 :VERSION 31
 :_US_AA_D_CREATION_DATE 20220415000000
