...
if (s_pathFile.probefile())
{
    ...
    with(plw.no_locking)
    {
    	...
    	var vNewFold=san_create_date_folder(vNow,context.SAN_UF_S_MAIN_PATH+context.SAN_CS_DATAHUB_ARCH_IMPORT_PATH);
    	if (vNewFold!=\"\")
    	{
...
//var s_pathFile = context.SAN_UF_S_MAIN_PATH+context.SAN_CS_IMPACT_IMPORT_PATH+s_fileName;
var s_pathFile = \"/tmp/istore_sites_subjects.json\";
...
if (s_pathFile.probefile())
{
    ...
    with(plw.no_locking)
    {
    	...
    	for (var o in vec_obj)
    	{
    		...
    		iStore_study_code=o.STUDY_CODE;
    		iStore_country_code=o.COUNTRY_CODE;
    		iStore_actual_subject=o.ACTUAL_SUBJECTS;
...
"
 ...
 :VERSION 24
 :_US_AA_D_CREATION_DATE 20220119000000
