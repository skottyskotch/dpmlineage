...
(JAVASCRIPT::SCRIPT-VERSION
 :OBJECT-NUMBER 260109628874
 :DATASET 118081000141
 :SCRIPT-CODE "namespace san_rdpm_batch_sync;
// List all activities 
...
for(var o_act_type in plc.wbs_type where o_act_type.SAN_UA_RDPM_B_BATCH_SYNCHRO)
{
	...
	for(var o_act in o_act_type.get(\"r.WBS_TYPE.WORK-STRUCTURE\") where o_act.SYNCHRONIZE_WITH!=undefined && (o_act.PROJECT.STATE==\"Active\" || o_act.PROJECT.STATE==\"Simulation\"))
	{
