...
function san_rdpm_bo_clinical_milestones_export()
{
	...
	for (var clin_ms in plc.__USER_TABLE_SAN_RDPM_UT_CLINICAL_MILESTONES where clin_ms.INACTIVE==false)
	{
		...
		var clin_ms_rule_country_planned = \"\";
		var clin_ms_rule_country_actual = \"\";
		...
		{
			// Vaccines rules only
			//if (clin_ms_rule.SAN_RDPM_UA_S_APPLY_TO==\"VACCINES\" || clin_ms_rule.SAN_RDPM_UA_S_APPLY_TO==\"COMMON\" || clin_ms_rule.SAN_RDPM_UA_S_APPLY_TO==\"PHARMA\")
			{
				...
				else
				{
					...
					else
					{
						if (clin_ms_rule.SAN_RDPM_UA_S_LEVEL==\"COUNTRY\")
						{
							if (clin_ms_rule.SAN_RDPM_UA_S_MILESTONE_TYPE==\"PLANNED\")
							{
								clin_ms_rule_country_planned = clin_ms_rule;
							}
							else
							{
								if (clin_ms_rule.SAN_RDPM_UA_S_MILESTONE_TYPE==\"ACTUAL\")
								{
									clin_ms_rule_country_actual = clin_ms_rule;
								}
							}
						}
					}					
		...
		// Process Country
		if (clin_ms_rule_country_planned!=\"\" || clin_ms_rule_country_actual!=\"\")
		{
...
//*******************************************************************************************************************************************************//"
 ...
 :VERSION 24
 :_US_AA_D_CREATION_DATE 20230524000000
