		...
		for(var o_project in plc.project where o_project.DELETED==false  && (o_project.STATE==\"Active\" || o_project.STATE==\"Simulation\") && o_project.SAN_RDPM_UA_B_NEW_PROJECT && o_project.SAN_RDPM_UA_PM_PRJ_PORT!=undefined)
		{
			...
			if (email_recipient!==\"\")
			{
				...
				if (o_project.SAN_RDPM_UA_PRJ_RND_PRJ_VAC)
				{
					...
					body=body+\"<p>Portfolio : \" +o_project.SAN_RDPM_UA_PM_PRJ_PORT+ \"<br>\";
					body=body+\"Project code : \" +o_project.SAN_UA_RWE_PROJECT_CODE_PRIME+ \"<br>\";
					body=body+\"Name : \" +o_project.NAME + \"<br>\";
					body=body+\"Description : \" +o_project.DESC+ \"<br>\";
					body=body+\"Project site : \" +o_project.SAN_RDPM_UA_PM_PROJECT_SITE+ \"<br>\";
					body=body+\"Franchise : \" +o_project.SAN_RDPM_UA_FRANCHISE+ \"<br>\";
					body=body+\"Vaccines project category : \" +o_project.SAN_RDPM_UA_VACC_PROJ_CAT+ \"<br>\";
					body=body+\"Vaccines project sub-category : \" +o_project.SAN_RDPM_UA_VACC_PROJ_SUB_CAT + \"<br>\";
					...
					body=body+\"Global Project Manager : \" +o_project._PO_DA_S_PROJECT_ROLE_296636645540 + \"<br>\";
				...
				else
				{
					...
					{
						subject = \"A new indication has been created in RDPM for the project \"+ o_project.SAN_UA_RWE_PROJECT_CODE_PRIME +\" - \"+o_project.NAME;
						var body = \"\";
						body=body+\"<html><p>Dear user,</p><p>Please be informed that for the project \"+ o_project.SAN_UA_RWE_PROJECT_CODE_PRIME +\" - \"+o_project.NAME+ \" a new indication has been created with the following information: </p>\";
						body=body+\"<p>Portfolio : \" +o_project.SAN_RDPM_UA_PM_PRJ_PORT+ \"<br>\";
						body=body+\"Project code : \" +o_project.SAN_UA_RWE_PROJECT_CODE_PRIME+ \"<br>\";
						body=body+\"Name : \" +o_project.NAME + \"<br>\";
						body=body+\"Description : \" +o_project.DESC+ \"<br>\";
...
"
 ...
 :VERSION 5
 :_US_AA_D_CREATION_DATE 20220216000000
