...
function san_wbs_form_leader_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_wbs_form_data_value(act_onb,role_onb,\"USER_ATTRIBUTE_SAN_UA_S_LEADER\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
}
        ...
        with(act_obj.fromobject()) {
            ...
            //plw.alert(\"act_child_leader: \"+act_child_leader);
                ...
                if (nvalue!=\"\") {
                    ...
                    act_child.SAN_RDPM_UA_S_PHARMA_LEADER=san_pjs_get_upper_level_value(act_onb,role_onb,\"USER_ATTRIBUTE_SAN_UA_S_LEADER\");
                }
                }
            }
        }
...
function san_wbs_form_sourcing_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_wbs_form_data_value(act_onb,role_onb,\"USER_ATTRIBUTE_SAN_UA_S_SOURCING_OBJ\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
...
function san_wbs_form_sourcing_conso_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_upper_level_value(act_onb,role_onb,\"USER_ATTRIBUTE_SAN_UA_S_SOURCING_OBJ\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
}
