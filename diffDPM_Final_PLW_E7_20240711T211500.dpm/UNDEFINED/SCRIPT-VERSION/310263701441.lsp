...
try{
    with(plw.no_locking){
        for ( var o_role in  plc.__USER_TABLE_SAN_RDPM_UT_PROJECT_ROLE where o_role.SAN_RDPM_UA_PROJECT_ROLE_B_VISIBLE_PRJ_LEVEL ){
            san_rdpm_create_project_role_slot_dynamic_attribute(o_role.ONB,o_role.DESC,o_role.NAME);
		}
    }
...
try{
    with(plw.no_locking){
        for ( var o_role in  plc.__USER_TABLE_SAN_RDPM_UT_PROJECT_ROLE where o_role.SAN_RDPM_UA_PROJECT_ROLE_B_VISIBLE_PRJ_LEVEL )
		    san_rdpm_create_object_project_role_dynamic_attribute(o_role.ONB,o_role.DESC,plc.work_structure);
    }
...
try{
    with(plw.no_locking){
        for ( var o_role in  plc.__USER_TABLE_SAN_RDPM_UT_PROJECT_ROLE where o_role.SAN_RDPM_UA_PROJECT_ROLE_B_VISIBLE_PRJ_LEVEL )
		    san_rdpm_create_object_project_role_dynamic_attribute(o_role.ONB,o_role.DESC,plc.expenditure);
    }
...
try{
    with(plw.no_locking){
        for ( var o_role in  plc.__USER_TABLE_SAN_RDPM_UT_PROJECT_ROLE where o_role.SAN_RDPM_UA_PROJECT_ROLE_B_VISIBLE_PRJ_LEVEL )
		    san_rdpm_create_object_project_role_dynamic_attribute(o_role.ONB,o_role.DESC,plc.task_alloc);
    }
...
try{
    with(plw.no_locking){
        for ( var o_role in  plc.__USER_TABLE_SAN_RDPM_UT_PROJECT_ROLE where o_role.SAN_RDPM_UA_PROJECT_ROLE_B_VISIBLE_PRJ_LEVEL )
		    san_rdpm_create_object_project_role_dynamic_attribute(o_role.ONB,o_role.DESC,plc.work_performed);
    }
...
"
 ...
 :VERSION 33
 :_US_AA_D_CREATION_DATE 20210804000000
