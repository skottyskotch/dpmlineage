...
// Monthly Baseline
if (\"PRINT_DATE\".call(date,\"DD-MM-YYYY\")==\"PRINT_DATE\".call(context.SAN_RDPM_UA_OC_D_PHARMA_BASELINE_DATE,\"DD-MM-YYYY\"))
{
	//var month_number = 12;
	...
	baseline_name_template.set(\"3\",\"QUATERLY_\"+year_number_string+\"_03_PHARMA\");
	...
	baseline_name_template.set(\"6\",\"QUATERLY_\"+year_number_string+\"_06_PHARMA\");
	...
	baseline_name_template.set(\"9\",\"QUATERLY_\"+year_number_string+\"_09_PHARMA\");
	...
	baseline_desc_template.set(\"6\",\"Quaterly\"+year_number_string+\" June Pharma Baseline\");
...
"
 ...
 :VERSION 12
 :_US_AA_D_CREATION_DATE 20210204000000
