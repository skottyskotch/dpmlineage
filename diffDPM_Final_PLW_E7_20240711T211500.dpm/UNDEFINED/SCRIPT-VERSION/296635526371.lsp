...
//SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_COSTS:Json file format\", \"IMPEX_PLANNED_COSTS:DATAHUBPLANNEDCOSTS\",\"ALL LEVEL 1 - DO NOT DELETE - USED FOR BO EXPORTS\", \"SAN_RDPM_QY_BO_PLANNED_COST\", start_date, end_date);

////Planned workload
//var start_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",-2)\");
//var end_date = Context.CallDateFormula(\"$TIME_WINDOW_END\");
//SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_WKL:Json file format\", \"IMPEX_PLANNED_WKL:DATAHUBPLANNEDWORKLOAD\",\"ALL LEVEL 1 - DO NOT DELETE - USED FOR BO EXPORTS\", \"SAN_RDPM_QY_BO_PLANNED_WKL\", start_date, end_date);
...
san_rdpm_bo_planned_wkl_export();
