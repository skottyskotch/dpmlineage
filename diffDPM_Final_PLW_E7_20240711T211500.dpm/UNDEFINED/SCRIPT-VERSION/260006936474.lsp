...
function san_pjs_get_wbs_form_data_value(act_onb,role_onb,field) {
	...
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_S_LEADER\",\"__USER_ATTRIBUTE_SAN_UA_B_LEADER_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_S_LEADER_SITE\",\"__USER_ATTRIBUTE_SAN_UA_B_LEADER_SITE_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_S_SOURCING\",\"__USER_ATTRIBUTE_SAN_UA_B_SOURCING_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_S_PROVIDER\",\"__USER_ATTRIBUTE_SAN_UA_B_PROVIDER_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_S_TEAM\",\"__USER_ATTRIBUTE_SAN_UA_B_TEAM_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_B_EXCLUDED_RES\",\"__USER_ATTRIBUTE_SAN_UA_B_EXCLUDED_RES_OVERWRITE\");
	vHash.set(\"__USER_ATTRIBUTE_SAN_UA_N_COMPLEXITY_FACTOR\",\"__USER_ATTRIBUTE_SAN_UA_B_COMPLEXITY_FACTOR_OVERWRITE\");
...
function san_wbs_form_complexity_factor_parent_slot_reader() {
	...
	var act_parent_onb=act_parent.ONB.tostring();
	var entered_value=san_pjs_get_upper_level_value(act_parent_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_N_COMPLEXITY_FACTOR\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
...
function san_wbs_form_leader_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_wbs_form_data_value(act_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_S_LEADER\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
}
...
function san_wbs_form_leader_slot_modifier(nvalue) {
    ...
    if (act_obj!=undefined && !act_obj.internal) {
        ...
        with(act_obj.fromobject()) {
            ...
            var act_child_leader=san_pjs_get_wbs_form_data_value(act_child_onb,role_onb,field);
            //plw.alert(\"act_child_leader: \"+act_child_leader);
                ...
                if (nvalue!=\"\") {
                    ...
                    act_child.SAN_RDPM_UA_S_PHARMA_LEADER=san_pjs_get_upper_level_value(act_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_S_LEADER\");
                }
                }
            }
        }
...
function san_wbs_form_leader_conso_slot_reader() {
    ...
    if (this.IS_A_LEAF) {
        var role_onb=this.ONB;
        var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
        var entered_value=san_pjs_get_upper_level_value(act_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_S_LEADER\");
        if (entered_value!=undefined && entered_value!=false) result=entered_value;
    }
    return result;
}
...
function san_wbs_form_sourcing_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_wbs_form_data_value(act_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_S_SOURCING_OBJ\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
...
function san_wbs_form_sourcing_conso_slot_reader() {
    ...
    var role_onb=this.ONB;
    var act_onb=context.SAN_UA_TMP_CURRENT_ACT_WBS_FORM_ONB;
    var entered_value=san_pjs_get_upper_level_value(act_onb,role_onb,\"__USER_ATTRIBUTE_SAN_UA_S_SOURCING_OBJ\");
    if (entered_value!=undefined && entered_value!=false) result=entered_value;
    return result;
}
