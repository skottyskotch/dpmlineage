...
function san_js2_insert_library() {
	...
	if (context.SAN_RDPM_UA_UG_PL_ACCESS){
	...
	if (b_plSelected) {
		answer = question(\"There is PL activities in your selection. Do you want to proceed without inserting the PL activities?\");
		if (answer==true) {
...
"
 ...
 :VERSION 1
 :_US_AA_D_CREATION_DATE 20201223000000
