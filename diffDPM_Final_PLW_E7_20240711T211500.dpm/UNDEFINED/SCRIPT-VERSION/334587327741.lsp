...
SanExport(\"SAN_RDPM_IMPEX_TARGET_DATAHUB_GENERIC_RESOURCE:Json file format\", \"Resource:DATAHUGENERICBRESOURCE\");
...
/*var start_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",-1)\");
var end_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",5)\");
SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM:Json file format\", \"IMPEX_PLANNED_DMM:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM\",\"ALL - DO NOT DELETE - USED FOR BO EXPORTS\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM\", start_date, end_date);*/
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////// !!!!!!!!!ALL NEW BO EXPORT SHOULD BE INSERTED BEFORE THIS PART!!!!!!!!!!!!/////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
for (var file in Dir where file.type!=\"zip\" && file.type!=\"success\"){
...
plw.writetolog(\" -- Export : ***** END EXPORT ****\");"
 ...
 :VERSION 62
 :_US_AA_D_CREATION_DATE 20230519000000
 :_US_AA_S_OWNER "E0455954"
)