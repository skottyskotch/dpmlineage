...
plw.writeln(argFormat+\"_\"+argTarget+\": not exported as it is not the day of the month configured.\");
}
...
SanExport(\"SAN_RDPM_IMPEX_TARGET_DATAHUB_SUCCESS_FILE:Json file format\", \"Project:DATAHUBSUCCESS\");"
 ...
 :VERSION 14
 :_US_AA_D_CREATION_DATE 20210211000000
