...
// Development Owner PH
function san_dev_pjt_ph_slot_reader() {
	return san_slot_reader(\"SAN_RDPM_UA_S_PJT_RESP_TA_RES\",\"PH\");
}

function san_rdpm_create_slot_dev_pjt_ph(){
	try{
		var slot = new objectAttribute(plc.task_alloc,\"SAN_RDPM_DA_LAST_DEV_PJT_PH\",\"BOOLEAN\");
		slot.Comment = \"Flag for last Dev Project owner PH\";
		slot.Reader = san_dev_pjt_ph_slot_reader;
		slot.Locker = true;
		slot.hiddenInIntranetServer = true;
		slot.connecting = false;
	}
...
// Development Owner CRD
function san_dev_pjt_crd_slot_reader() {
	return san_slot_reader(\"SAN_RDPM_UA_S_PJT_RESP_TA_RES\",\"CRD\");
}

function san_rdpm_create_slot_dev_pjt_crd(){
	try{
		var slot = new objectAttribute(plc.task_alloc,\"SAN_RDPM_DA_LAST_DEV_PJT_CRD\",\"BOOLEAN\");
		slot.Comment = \"Flag for last Dev Project owner CRD\";
		slot.Reader = san_dev_pjt_crd_slot_reader;
		slot.Locker = true;
		slot.hiddenInIntranetServer = true;
		slot.connecting = false;
	}
...
// Development Owner SCS
function san_dev_pjt_scs_slot_reader() {
	return san_slot_reader(\"SAN_RDPM_UA_S_PJT_RESP_TA_RES\",\"SCS\");
}

function san_rdpm_create_slot_dev_pjt_scs(){
	try{
		var slot = new objectAttribute(plc.task_alloc,\"SAN_RDPM_DA_LAST_DEV_PJT_SCS\",\"BOOLEAN\");
		slot.Comment = \"Flag for last Dev Project owner SCS\";
		slot.Reader = san_dev_pjt_scs_slot_reader;
		slot.Locker = true;
		slot.hiddenInIntranetServer = true;
		slot.connecting = false;
	}
...
"
 ...
 :VERSION 65
 :_US_AA_D_CREATION_DATE 20221207000000
