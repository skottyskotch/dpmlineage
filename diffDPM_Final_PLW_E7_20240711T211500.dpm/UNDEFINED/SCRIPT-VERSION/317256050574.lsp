...
//  PC-4983 - Use the portfolio ALL - DO NOT DELETE - USED FOR BO EXPORTS [PC-4983] for BO Project, Indication, Phase, Study, Task, Team Member - 2021/11/09 LFA
...
context._FF_AA_S_LIST_NAME = \"ALL - DO NOT DELETE - USED FOR BO EXPORTS [PC-4983]\";
...
plw.writeln(\"Exports: Success, on portfolio: \"+context._FF_AA_S_LIST_NAME.toString());"
 ...
 :VERSION 45
 :_US_AA_D_CREATION_DATE 20211110000000
