		...
		for(var o_project in plc.project where o_project.DELETED==false  && (o_project.STATE==\"Active\" || o_project.STATE==\"Simulation\") && o_project.SAN_RDPM_UA_B_NEW_PROJECT && o_project.SAN_RDPM_UA_PM_PRJ_PORT!=undefined)
		{
			...
			if (email_recipient!=\"\")
			{
				...
				if (o_project.SAN_RDPM_UA_PRJ_RND_PRJ_VAC)
				{
					...
					var test1 = o_project.SAN_RDPM_UA_PM_PRJ_PORT.printattribute();
					var test2 = o_project.SAN_UA_RWE_PROJECT_CODE_PRIME.printattribute();
					plw.alert(test1);
					plw.alert(test2);
				...
				else
				{
					if (o_project.SAN_RDPM_UA_PRJ_RND_IND_VAC)
					{
						...
						body=body+\"Name : \" +o_project.callstringformula(\"STRING_VALUE(\\\"activity\\\",parent+\\\"/\\\"+id,\\\"SAN_RDPM_UA_INDICATION_CODE\\\")\") + \"<br>\";
						body=body+\"Description : \" +o_project.DESC+ \"</p>\";
						body=body+\"<p>Thank you!\"+ \"<br>\";
						body=body+\"This email is generated automatically, please do not reply!</p></html>\";
					}
				}
