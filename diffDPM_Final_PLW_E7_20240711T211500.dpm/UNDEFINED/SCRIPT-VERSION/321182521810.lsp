...
{	
	...
	{
		for(var o_project in plc.project where o_project.DELETED==false  && (o_project.STATE==\"Active\" || o_project.STATE==\"Simulation\") && o_project.SAN_RDPM_UA_B_NEW_PROJECT && o_project.SAN_RDPM_UA_PM_PRJ_PORT!=undefined)
		{
			var body = \"\";
			var email_recipient=\"\";
			var subject = \"\";
			...
			if (email_recipient!==\"\")
			{
				...
				if (o_project.SAN_RDPM_UA_PRJ_RND_PRJ_VAC)
				{
					...
					// To update with right fields
					var body = \"\";
					body=body+\"<html><p>Dear user,</p><p>Please be informed that a new \"+ proj.SAN_RDPM_UA_PM_PRJ_PORT.name +\" project has been created with the following information:</p>\";
					body=body+\"<p>Portfolio : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Project code : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Name : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Description : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Project site : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Franchise : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Vaccines project category : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Vaccines project sub-category : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Objective : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Global Project Head : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"Global Project Manager : \" +proj.SAN_RDPM_UA_PM_PRJ_PORT.name + \"<br>\";
					body=body+\"<p>Thank you!\"+ \"<br>\";
					body=body+\"<p>This email is generated automatically, please do not reply!</p></html>\";
				}
				else
				{
					if (o_project.SAN_RDPM_UA_PRJ_RND_IND_VAC)
					{
						// To complete with subject and body
					}
				}
...
"
 ...
 :VERSION 4
 :_US_AA_D_CREATION_DATE 20220215000000
