	...
	if(vRes != undefined && vRes instanceOf plc.Resource) {
		...
		if (ResSkill!= undefined) {
			...
			if (vResTcProfile==\"PHARMA\") {
				...
				plw.writeln(\"Nb of distinct studies / financial tasks: \"+total_distinct_std_ft);
				plw.writeln(\"Nb of insertable studies  / financial tasks: \"+total_std_insertable);
...
wrap.intranetstarted.addwrapperafter(san_rdpm_init_table_key_plh_skill);"
 ...
 :VERSION 23
 :_US_AA_D_CREATION_DATE 20210409000000
