...
{   
    var debut = new Date();
    var heure = debut.gethours();
    var minute = debut.getminutes();
    var seconde = debut.getseconds();
    plw.alert(heure+\" : \"+minute+\" : \"+seconde);
	...
	var fin = new Date();
	var t_fin= fin.getElapsedTime();
		var t_start= debut.getElapsedTime();
		var duration = t_start-t_fin;
        plw.alert(duration);
