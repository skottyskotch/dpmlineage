...
function san_rdpm_get_clinical_milestone_date(act,clin_ms_rule)
{
	...
	{
	for (var act_type in clin_ms_rule.get(\"USER_ATTRIBUTE_INVERSE_SAN_RDPM_UA_S_CLIN_MS_RULE.__USER_TABLE_SAN_RDPM_UT_MAP_CLIN_MS_ACT_TYPE\") /*order by ['SAN_RDPM_UA_N_ORDER']*/)
	{
