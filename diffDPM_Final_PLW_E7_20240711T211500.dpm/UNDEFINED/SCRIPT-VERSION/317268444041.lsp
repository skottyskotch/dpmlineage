...
//  Add relation for workboxe Team member users to manage (PC-4272)
//
...
// ------------------------- PC-4272 : Relation for workbox Team member users to manage -----------------------

// Function to get team members (users) that do not have correct access rights
function san_rdpm_js2_tm_to_manage(f){
...
//dynamic relation between context user and users
function san_rdpm_dr_tm_to_manage(){
	var SAN_RDPM_REL_TM_TO_MANAGE = new ObjectRelation(plc.contextopx2,\"SAN_RDPM_REL_TM_TO_MANAGE\");
	SAN_RDPM_REL_TM_TO_MANAGE.Mapmethod = san_rdpm_js2_tm_to_manage;
	SAN_RDPM_REL_TM_TO_MANAGE.ConnectedToClass = plc.opx2_user;
	SAN_RDPM_REL_TM_TO_MANAGE.Comment = \"Team Member Users to Manage\";
}
...
try{
	...
	plw.writeToLog(\"Failed to create SAN_RDPM_REL_TM_TO_MANAGE\");
	plw.writeln(e);
}"
