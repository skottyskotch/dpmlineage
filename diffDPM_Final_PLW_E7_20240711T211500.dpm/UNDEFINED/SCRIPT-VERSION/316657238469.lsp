...
for (var vProj in plc.ordo_project where ( (vProj.SAN_RDPM_B_RND_VACCINES_PROJECT || vProj.SAN_RDPM_B_RND_PHARMA_PROJECT ) && vProj.PARENT.printattribute()==\"\" && vProj._INF_NF_S_PRJ_STATE_INTERNAL  == \"ACTIVE\" && vProj._INF_NF_B_IS_TEMPLATE != true && vProj._WZD_AA_B_PERMANENT != true )) 
