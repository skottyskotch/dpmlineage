...
function san_rdpm_js2_get_planned_project_objectives(o_project)
{
	...
	var list = [];
	for(var o_proj_obj_report_mile_type in plc.__USER_TABLE_SAN_RDPM_UT_REPORT_MILE_TYPE where \"Project Objective\".parsevector().position(o_proj_obj_report_mile_type.printattribute())!=undefined)
	{
