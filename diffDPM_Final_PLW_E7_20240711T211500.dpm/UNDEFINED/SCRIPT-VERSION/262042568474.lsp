...
{
	prjObj=plc.project.get(vAct.project.SAN_RDPM_UA_PRJ_S_ROOT_PROJECT);
	exception_formula = plw.compile_reference_activity_filter(refName,prjObj,vAct.printattribute());
...
for (var vact in manual_baseline.get(\"USER_ATTRIBUTE_INVERSE_SAN_RDPM_UA_S_MANUAL_STUDY_BASELINE.WORK-STRUCTURE\"))
{
	...
	act.SAN_RDPM_UA_B_TAKE_STUDY_BASELINE=false;
}
...
for (var vact in Study_Baseline_1.get(\"USER_ATTRIBUTE_INVERSE_SAN_RDPM_UA_S_MANUAL_STUDY_BASELINE.WORK-STRUCTURE\"))
{
	san_rdpm_take_study_baseline(vAct,refName,refDesc);
	with(plw.no_locking){act.SAN_RDPM_UA_B_STUDY_BASELINE_TAKEN=true;}
}
...
for (var vact in Study_Baseline_2.get(\"USER_ATTRIBUTE_INVERSE_SAN_RDPM_UA_S_MANUAL_STUDY_BASELINE.WORK-STRUCTURE\"))
{
	san_rdpm_take_study_baseline(vAct,refName,refDesc);
	with(plw.no_locking){act.SAN_RDPM_UA_B_STUDY_BASELINE_TAKEN=true;}
}
...
for (var vact in Study_Baseline_3.get(\"USER_ATTRIBUTE_INVERSE_SAN_RDPM_UA_S_MANUAL_STUDY_BASELINE.WORK-STRUCTURE\"))
{
	san_rdpm_take_study_baseline(vAct,refName,refDesc);
	with(plw.no_locking){act.SAN_RDPM_UA_B_STUDY_BASELINE_TAKEN=true;}
}"
