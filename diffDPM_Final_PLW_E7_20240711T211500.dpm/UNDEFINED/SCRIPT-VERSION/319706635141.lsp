...
san_import_datahub_data('Country Groups:SAN_RDPM_IMPEX_IMP_FORMAT_COUNTRY_GROUP','country_groups.json');
san_import_datahub_data('Relations Country - Country Group:SAN_RDPM_IMPEX_IMP_FORMAT_COUNTRY_COUNTRYGROUP_REL','country_country_group_rel.json');"
 ...
 :VERSION 14
 :_US_AA_D_CREATION_DATE 20220202000000
