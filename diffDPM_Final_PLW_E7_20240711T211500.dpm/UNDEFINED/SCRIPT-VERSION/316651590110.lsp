...
var slot = new objectAttribute(plc.workstructure,\"SAN_RDPM_DA_IS_FIRST\",\"BOOLEAN\");
...
var slot = new objectAttribute(plc.workstructure,\"SAN_RDPM_DA_IS_LAST\",\"BOOLEAN\");
