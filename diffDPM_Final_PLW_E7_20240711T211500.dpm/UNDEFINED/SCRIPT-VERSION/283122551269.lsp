...
vNewFold=san_create_date_folder(vNow,context.SAN_CS_DATAHUB_ARCH_IMPORT_PATH);
...
san_import_datahub_data('Study Codes:SAN_IMPEX_IMP_STUDY_CODES','study_codes.json');"
 ...
 :VERSION 5
 :_US_AA_D_CREATION_DATE 20210219000000
