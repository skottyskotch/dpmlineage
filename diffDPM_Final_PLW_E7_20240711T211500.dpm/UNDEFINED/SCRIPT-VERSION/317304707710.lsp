...
var start_date = Context.CallDateFormula(\"period_start(OC.SAN_RDPM_CS_NOMINATIVE_ACTUAL_WKL_EXPT_DAY_MANU,\\\"MONTH\\\",-1)\");
var end_date = Context.CallDateFormula(\"period_start(OC.SAN_RDPM_CS_NOMINATIVE_ACTUAL_WKL_EXPT_DAY_MANU,\\\"MONTH\\\",0)\");
