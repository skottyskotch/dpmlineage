...
function san_pjs_launch_tc_integration_subbatches(run_batch) {
	...
	_san_batch_int.san_pjs_generic_send_mail_continuum_env(\"sanofi-continuum@planisware.com\",\"Integration batch is starting...\",body_st);
}
...
function san_pjs_launch_tc_integration_subbatch_for_instance(integer instance_nb) {
	...
	_san_batch_int.san_pjs_generic_send_mail_continuum_env(\"sanofi-continuum@planisware.com\",\"SAN_RDPM_JS2_TC_INT_SUBBATCH_\"+ibatchStr+\" starting...\",\"RDPM - START BATCH : SAN_RDPM_JS2_TC_INT_SUBBATCH_\"+ibatchStr);
	var vDate=new date();
	var vStart_Month =  \"PERIOD_START\".callmacro(vDate,\"MONTH\",-1);
	var vEnd_Month =  \"PERIOD_START\".callmacro(vDate,\"MONTH\",0);
	...
	_san_batch_int.san_pjs_generic_send_mail_continuum_env(\"sanofi-continuum@planisware.com\",\"SAN_RDPM_JS2_TC_INT_SUBBATCH_\"+ibatchStr+\" finished!\",tc_vect.length+\" integrated timesheets on \"+count_res+\" resources in instance \"+instance_nb);
}"
 :SOURCE-DCR-SYNC-OBJECTS 0
 :USER-SCRIPT 336983920741
 :VERSION 1
