...
function san_rdpm_cso_fte_costs_export()
{
	...
	var s_filepath = context.SAN_UF_S_MAIN_PATH+context.SAN_CS_CSO_FTE_COSTS_PATH;
...
{
	var s_filepath = context.SAN_UF_S_MAIN_PATH+context.SAN_CS_CSO_FTE_COSTS_PATH+context.SAN_RDPM_UA_OC_S_CSO_FILE_DOWNLOAD;
...
function san_rdpm_cso_fte_costs_upload()
{
	...
	if (fileToImport!=undefined && fileToImport!=\"\") {
		...
		var vPath = new plw.pathname(context.SAN_UF_S_MAIN_PATH+context.SAN_CS_CSO_FTE_COSTS_PATH+'CSO_FTE_COSTS_IMPORT.csv');
 ...
 :VERSION 2
 :_US_AA_D_CREATION_DATE 20210517000000
