...
//
//  Modification 0.4: 2023/22/11 GSE
//  Extension of import scope with Current Year + 2 next Year instead of Current Quarter + 2 next Year for san_rdpm_cso_fte_import function
//
...
function san_rdpm_cso_fte_export()
{
	...
	var d_end_horizon_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",3)\");
