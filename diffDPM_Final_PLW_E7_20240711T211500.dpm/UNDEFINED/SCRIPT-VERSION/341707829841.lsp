...
{ 
	...
	for (var act in activity_vector where act instanceof plc.workstructure)
	{
		...
		{
			planned_date = _rdpm_clinical_milestones.san_rdpm_get_clinical_milestone_date(act,rule_planned);
			if (planned_date!=-1)
			{
		...
		{
			actual_date = _rdpm_clinical_milestones.san_rdpm_get_clinical_milestone_date(act,rule_actual);
			if (actual_date!=-1)
			{
...
function san_rdpm_bo_clinical_milestones_export()
{
	...
	ClinMSFile.writeln(\"\\\"CLINICAL_MILESTONE\\\",\\\"LEVEL\\\",\\\"ACTIVITY_ID\\\",\\\"ACTIVITY_ONB\\\",\\\"PLANNED_DATE\\\",\\\"ACTUAL_DATE\\\",\\\"SAN_RDPM_UA_S_FUNC_DESC\\\",\\\"SAN_RDPM_UA_S_COUNTRY_STUDY_ACT\\\",\\\"SAN_RDPM_UA_ACT_ACTION_CSO\\\"\");
...
//*******************************************************************************************************************************************************//"
 ...
 :VERSION 27
 :_US_AA_D_CREATION_DATE 20240305000000
