					...
					for(var o_hes in plc.TIME_SYNTHESIS where o_hes.RES.SAN_RDPM_UA_B_RES_SPECIES==false &&  ((o_hes.FD instanceof DATE) && !(o_hes.FD<start_horizon_date) && (o_hes.SD instanceof DATE) && !(o_hes.SD>end_horizon_date)) && !(o_hes.ACTIVITY.SAN_RDPM_UA_B_OLD_BRANCH_FILTER_F))
						{
						    ...
						    v_hes_string_wkl += \"\\\"\"+o_hes.COMMENT+\"\\\"\"+file_separator;
...
plw.writetolog(\"Cleaning table WBS Form Data.\");
var count=0;
...
plw.writetolog(count + \" duplicated lines removed in table WBS Form Data.\");

//PC-4983 - Export Pharma and Vaccines Project
//Portfolio filter to be set prior to the call of the export to restrict the data exported
context._FF_AA_S_LIST_NAME = \"ALL R&D - DO NOT DELETE - USED FOR BO EXPORTS [TEMP]\";
...
//PC-4983 - Export Only Pharma Project
//Portfolio filter to be set prior to the call of the export to restrict the data exported
...
//Portfolio (PC-1744)
plw.writeln(\"Exporting: Portfolios\");
...
plw.writeln(\"Exports: Success, on portfolio: \"+context._FF_AA_S_LIST_NAME.toString());
"
 :SOURCE-DCR-SYNC-OBJECTS 0
 :USER-SCRIPT 260025536771
 :VERSION 50
 :_US_AA_D_CREATION_DATE 20220203000000
