...
function san_rdpm_check_act_can_be_inserted(act) {
	var result=false;
	if (Act.getinternalvalue(\"STATE\").ToString()==\"O\" && Act.CallBooleanFormula(\"MATCH_STRING(OC._TCM_AA_S_SA_ACTIVITYFILTER)\") && 
...
function san_rdpm_pjs_tcm_addActivityInTimesheet(id) {
 ...
 :VERSION 17
 :_US_AA_D_CREATION_DATE 20210303000000
