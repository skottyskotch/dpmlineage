...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 282705872274
 :NAME "SAN_CONTINUUM_JS2_BASELINES_BATCH"
 :COMMENT "RDPM Baselines Batch"
 :ACTIVE T
...
*
* JIRA : PC-7409 - Modification for Monthly Baseline Pharma with new date to take into account
* Date Modification : 06/06/2024 by Guillaume SETRICK
*
...
*
* JIRA : PC-5359 - Check if the baseline taken is not the same as the previous one 
* Date Modification : 11/05/2022 by William
*
* JIRA : PC-5961 - Remove calculation on the fields 'Vaccine project Category' and 'Project stage'
* Date Modification : 19/07/2022 by William
*/
...
if (context.SAN_RDPM_UA_OC_D_PHARMA_BASELINE_DATE!=undefined && \"PRINT_DATE\".call(date,\"DD-MM-YYYY\")==\"PRINT_DATE\".call(context.SAN_RDPM_UA_OC_D_PHARMA_BASELINE_DATE,\"DD-MM-YYYY\"))
{
	...
	baseline_name_template.set(\"1\",year_number_string+\"_12_MONTHLY\");
	baseline_name_template.set(\"2\",year_number_string+\"_01_MONTHLY\");
	baseline_name_template.set(\"3\",year_number_string+\"_02_MONTHLY\");
	baseline_name_template.set(\"4\",year_number_string+\"_03_MONTHLY\");
	baseline_name_template.set(\"5\",year_number_string+\"_04_MONTHLY\");
	baseline_name_template.set(\"6\",year_number_string+\"_05_MONTHLY\");
	baseline_name_template.set(\"7\",year_number_string+\"_06_MONTHLY\");
	baseline_name_template.set(\"8\",year_number_string+\"_07_MONTHLY\");
	baseline_name_template.set(\"9\",year_number_string+\"_08_MONTHLY\");
	baseline_name_template.set(\"10\",year_number_string+\"_09_MONTHLY\");
	baseline_name_template.set(\"11\",year_number_string+\"_10_MONTHLY\");
	baseline_name_template.set(\"12\",year_number_string+\"_11_MONTHLY\");
	var Ref_Name =baseline_name_template.get(month_number_string);
	// Baseline desc
	var baseline_desc_template = new hashtable(\"STRING\");
	baseline_desc_template.set(\"1\",year_number_string+\"-12 Monthly\");
	baseline_desc_template.set(\"2\",year_number_string+\"-1 Monthly\");
	baseline_desc_template.set(\"3\",year_number_string+\"-2 Monthly\");
	baseline_desc_template.set(\"4\",year_number_string+\"-3 Monthly\");
	baseline_desc_template.set(\"5\",year_number_string+\"-4 Monthly\");
	baseline_desc_template.set(\"6\",year_number_string+\"-5 Monthly\");
	baseline_desc_template.set(\"7\",year_number_string+\"-6 Monthly\");
	baseline_desc_template.set(\"8\",year_number_string+\"-7 Monthly\");
	baseline_desc_template.set(\"9\",year_number_string+\"-8 Monthly\");
	baseline_desc_template.set(\"10\",year_number_string+\"-9 Monthly\");
	baseline_desc_template.set(\"11\",year_number_string+\"-10 Monthly\");
	baseline_desc_template.set(\"12\",year_number_string+\"-11 Monthly\");
	...
	// PC-5359 - Check if the baseline taken is not the same as the previous one
	if (previous_monthly_baseline_name!=Ref_Name)
	{
...
if (context.SAN_RDPM_UA_OC_D_VACCINES_MONTHLY_BASELINE_DATE!=undefined && \"PRINT_DATE\".call(date,\"DD-MM-YYYY\")==\"PRINT_DATE\".call(context.SAN_RDPM_UA_OC_D_VACCINES_MONTHLY_BASELINE_DATE,\"DD-MM-YYYY\"))
{
	...
	// PC-5961 - Remove calculation on the fields 'Vaccine project Category' and 'Project stage'
