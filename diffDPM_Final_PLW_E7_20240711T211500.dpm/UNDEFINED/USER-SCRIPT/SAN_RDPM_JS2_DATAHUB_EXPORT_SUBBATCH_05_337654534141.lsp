...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 337654534141
 :NAME "SAN_RDPM_JS2_DATAHUB_EXPORT_SUBBATCH_05"
 :COMMENT "EXPORT_SUBBATCH_05"
 :ACTIVE T
...
plw.writetolog(\"\");
plw.writetolog(\" #########   SAN_RDPM_BA_DATAHUB_EXPORT_SUBBATCH_05 is starting...   #########\");
...
//LIST EXPORT START
_impexTarget.san_rdpm_bo_actual_workload();
//LIST EXPORT END

// generate the subbatch success file and scan the success file from other subbatch to generate (or not) the global file export.sucess
plw.writetolog(\"\");
...
_impexTarget.san_js_generate_exportsuccess_subbatch_file(5,start_time_string);
plw.writetolog(\"\");
plw.writetolog(\" #########   END OF SAN_RDPM_BA_DATAHUB_EXPORT_SUBBATCH_05   #########\");"
