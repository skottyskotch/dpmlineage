...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 296654818774
 :NAME "SAN_RDPM_J2S_IMPACT_UPDATE"
 :COMMENT "Update actual dates from IMPACT"
 :ACTIVE T
...
//
//  V2.3 - 2022-05-09 - PC-6080 - Update field name ENTERED_TREATMENT by ACTUAL_SUBJECTS 
