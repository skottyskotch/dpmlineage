...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 316646123941
 :NAME "SAN_RDPM_J2S_PM_FUNCTION"
 :COMMENT "RDPM Project Module Functions"
 :ACTIVE T
...
// WST - PC-6366 - Fix on e-mail notifications when SAN_UA_RWE_PROJECT_CODE_PRIME is empty 
...
{	
	...
	{
		for(var o_project in plc.project where o_project.DELETED==false  && (o_project.STATE==\"Active\") && o_project._PM_NF_B_IS_A_VERSION==false && o_project.SAN_RDPM_UA_B_NEW_PROJECT && o_project.SAN_RDPM_UA_PM_PRJ_PORT!=undefined && o_project.SAN_RDPM_UA_PM_PRJ_PORT instanceof plc.__USER_TABLE_SAN_RDPM_UT_PM_PRJ_PORT)
		{
			var body = \"\";
			var email_recipient=\"\";
			var subject = \"\";
			//PC-6366
			var project_code = \"\";
			if (o_project.SAN_UA_RWE_PROJECT_CODE_PRIME!=\"\") {
			project_code = o_project.SAN_UA_RWE_PROJECT_CODE_PRIME.printattribute();
			}
			//e-mail recipient
			...
			if (email_recipient!=\"\")
			{
				...
				if (o_project.SAN_RDPM_UA_PRJ_RND_PRJ_VAC)
				{
					...
					body=body+\"Project code : \" +project_code+ \"<br>\";
				...
				else
				{
					...
					{
						subject = \"A new indication has been created in RDPM for the project \"+ project_code +\" - \"+o_project.PARENT.NAME;

						body=body+\"<html><p>Dear user,</p><p>Please be informed that for the project \"+ project_code +\" - \"+o_project.PARENT.NAME+ \" a new indication has been created with the following information: </p>\";
						body=body+\"<p>Portfolio : \" +o_project.SAN_RDPM_UA_PM_PRJ_PORT.printattribute()+ \"<br>\";
						body=body+\"Project code : \" +project_code+ \"<br>\";
