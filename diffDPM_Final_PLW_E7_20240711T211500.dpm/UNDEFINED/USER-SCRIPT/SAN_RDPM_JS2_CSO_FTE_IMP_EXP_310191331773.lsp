...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 310191331773
 :NAME "SAN_RDPM_JS2_CSO_FTE_IMP_EXP"
 :COMMENT "Script containing the functions to export and import CSO FTEs"
 :ACTIVE T
...
function san_rdpm_cso_fte_export()
{
	...
	var s_filepath = utilklib.gettempdirectory();
...
function san_rdpm_cso_fte_download_last_exported_file()
{
    ...
    var s_filepath = utilklib.gettempdirectory()+'CSO_FTEs_EXPORT.csv';
...
function san_rdpm_cso_fte_upload()
{
 ...
 :_US_AA_D_CREATION_DATE 20210507000000
