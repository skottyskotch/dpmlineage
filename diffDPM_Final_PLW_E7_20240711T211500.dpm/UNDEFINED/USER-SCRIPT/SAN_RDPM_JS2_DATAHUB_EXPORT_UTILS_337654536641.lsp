...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 337654536641
 :NAME "SAN_RDPM_JS2_DATAHUB_EXPORT_UTILS"
 :COMMENT "Datahub export utils"
 :ACTIVE T
...
//  Modification of san_rdpm_bo_planned_DMM function to include 10 years period
...
function san_rdpm_bo_planned_wkl_cost_export()
{
	...
	//var filepath = \"/tmp/\";
	var filepath = utilklib.gettempdirectory();
...
function san_rdpm_bo_planned_DMM_v2(){
	//Planned DMM
    var start_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",-1)\");
    var end_date = Context.CallDateFormula(\"period_start($DATE_OF_THE_DAY,\\\"YEAR\\\",10)\");
    //12 impex because 12 targets and 12 queries (1 per curve)
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_AUTOINJECTOR:JSON file format\", \"IMPEX_PLANNED_DMM_AUTOINJECTOR:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_AUTOINJECTOR\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_AUTOINJECTOR\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_CAPSULE:JSON file format\", \"IMPEX_PLANNED_DMM_CAPSULE:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_CAPSULE\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_CAPSULE\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_CARTRIDGE:JSON file format\", \"IMPEX_PLANNED_DMM_CARTRIDGE:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_CARTRIDGE\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_CARTRIDGE\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_GRAM:JSON file format\", \"IMPEX_PLANNED_DMM_GRAM:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_GRAM\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_GRAM\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_KG:JSON file format\", \"IMPEX_PLANNED_DMM_KG:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_KG\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_KG\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_KIT:JSON file format\", \"IMPEX_PLANNED_DMM_KIT:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_KIT\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_KIT\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_PEN:JSON file format\", \"IMPEX_PLANNED_DMM_PEN:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_PEN\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_PEN\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_TABLET:JSON file format\", \"IMPEX_PLANNED_DMM_TABLET:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_TABLET\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_TABLET\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_PFS:JSON file format\", \"IMPEX_PLANNED_DMM_FPS:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_FPS\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_FPS\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_VECTOR_GENOME:JSON file format\", \"IMPEX_PLANNED_DMM_VECTOR_GENOME:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_VECTOR_GENOME\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_VECTOR_GENOME\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_VIAL:JSON file format\", \"IMPEX_PLANNED_DMM_VIAL:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_VIAL\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_VIAL\", start_date, end_date);
    _impexTarget.SanExportFromPexQuery (\"SAN_RDPM_IMPEX_TARGET_DATAHUB_PLANNED_DMM_OTHER:JSON file format\", \"IMPEX_PLANNED_DMM_OTHER:SAN_RDPM_IMPEX_FORMAT_PLANEXP_DMM_OTHER\",\"ALL DMM - DO NOT DELETE - USED FOR BO EXPORT\", \"SAN_RDPM_QY_BO_PLANEDXP_DMM_OTHER\", start_date, end_date);
  		
	//Merge files in python
	var dt_now = new date();
	var s_timestamp = new date(dt_now.getyear(),dt_now.getmonth(),dt_now.getdate(),dt_now.gethours(),dt_now.getminutes(),00).tostring(\"YYYYMMDDTHHmmSSZ\");
	var s_pathFrom = context.SAN_RDPM_UA_OC_S_EXPORT_DATAHUB_PATH;
	var s_pathDest = context.SAN_UF_S_MAIN_PATH + context.SAN_CS_ARCHIVE_PATH;
	var s_fileDMMMerged = context.SAN_RDPM_UA_OC_S_EXPORT_DATAHUB_PATH + s_timestamp + \"-PLANNED_DMM.json\";
	var s_logPython = \"TracePython-PLANNED_DMM.log\";
	var s_logFilePython = s_pathFrom + s_logPython;
	var s_fileFrom =\"\";
	var s_fileDest =\"\";
	var v_fullPathFiles = new vector();
	var s_pythonFile = plw.callstringformula(\"$TEMPORARY_FILES_DIRECTORY\") + \"../scripts/mergeFile.py\";
	s_pythonFile = s_pythonFile.probefile();
	var v_files = new vector(\"PLANNED_DMM_AUTOINJECTOR.json\",\"PLANNED_DMM_CAPSULE.json\",\"PLANNED_DMM_CARTRIDGE.json\",\"PLANNED_DMM_GRAM.json\",\"PLANNED_DMM_KG.json\",\"PLANNED_DMM_KIT.json\",\"PLANNED_DMM_PEN.json\",\"PLANNED_DMM_TABLET.json\",\"PLANNED_DMM_PFS.json\",\"PLANNED_DMM_VECTOR_GENOME.json\",\"PLANNED_DMM_VIAL.json\",\"PLANNED_DMM_OTHER.json\");
	for (var s_file in v_files)
	{		
		v_fullPathFiles.push(s_pathFrom + s_file);
	}
	plw.writetolog(\"---- Call python file named 'mergeFile.py' to merge all DMM generated\");
	//Set argument to call python3 file mergeFile.py
	var v_args = [s_pythonFile,v_fullPathFiles.join(\",\"),s_fileDMMMerged,s_logFilePython];
	\"python3\".execute(v_args,true);
	//Check if merged file PLANNED_DMM well generated
	if (s_fileDMMMerged.probefile()) 
	{
		plw.writeToLog(\"---- Merged file DMM '\"+s_fileDMMMerged+\"' created with success! For more details, look at file: \"+ s_logFilePython);
	}
	else
	{
		plw.writeToLog(\"---- Merged file DMM '\"+s_fileDMMMerged+\"' not created... ERROR with mergeFile.py! For more details, look at file: \"+ s_logFilePython); 
		// Raise error if merged file not generated...
		var no_project=plc.ordo_project.get(\"no_project\");
		no_project.get(\"NAME\");				
	}
	//Move sub DMM files into upload/archive/ folder
	plw.writetolog(\"---- Move DMM files into /archive folder\");
	//Move also python log file
	v_files.push(s_logPython);
	for (var s_file in v_files)
	{		
		s_fileFrom = s_pathFrom + s_file;
		s_fileDest = s_pathDest + s_timestamp + \"-\" + s_file;
		if (!s_fileDest.probefile() && s_fileFrom.probefile()) {
			try {
				s_fileFrom.CopyFile(s_fileDest);
				s_fileFrom.deletefile();
				plw.writeToLog(\" ----- DMM file moved from: \\\"\" +s_fileFrom +\"\\\" ,to: \\\"\" +s_fileDest +\"\\\" with success.\");
			}
			catch (error CatchErr) {
				plw.writeToLog(\" ----- When moving DMM file: Cannot move : \\\"\" +s_fileFrom +\"\\\" ,to \\\"\" +s_fileDest +\"\\\"- file is certainly already locked by another software. Err: \"+ CatchErr);
			}
		}
		else {
		    plw.writeToLog(\"Dest file already exists '\"+s_fileDest+\"' or From file does not '\"+s_fileFrom+\"' so it could not be moved...\");
		}
	}
	plw.writeToLog(\"--- End of san_rdpm_bo_planned_DMM_v2 function.\");
}
