...
(JAVASCRIPT::USER-SCRIPT
 :OBJECT-NUMBER 337654534241
 :NAME "SAN_RDPM_JS2_DATAHUB_EXPORT_SUBBATCH_04"
 :COMMENT "EXPORT_SUBBATCH_04"
 :ACTIVE T
...
plw.writetolog(\"\");
plw.writetolog(\" #########   SAN_RDPM_BA_DATAHUB_EXPORT_SUBBATCH_04 is starting...   #########\");
...
//LIST EXPORT START
_impexTarget.SanExport(\"SAN_RDPM_IMPEX_TARGET_DATAHUB_TASK:JSON file format\", \"Activity:DATAHUBTASK\");
//LIST EXPORT END
...
_impexTarget.san_js_generate_exportsuccess_subbatch_file(4,start_time_string);
plw.writetolog(\"\");
plw.writetolog(\" #########   END OF SAN_RDPM_BA_DATAHUB_EXPORT_SUBBATCH_04   #########\");
